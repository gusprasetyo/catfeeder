<?php
include 'koneksi.php';
// Kode ini mengambil data terbaru dari tabel datadashboard dan menampilkannya dalam format JSON.  Jika terjadi kesalahan (query gagal atau tidak ada data), kode ini akan mengembalikan pesan error atau array kosong dalam format JSON juga.  Tujuannya adalah untuk menyediakan data dari database untuk bisa diakses via dashboard
